			...
			if (tab.url.startsWith('https://open.spotify.com')) {
				switch (command) {
					...
					case 'repeat':
						...
						break;
					case 'track-add':
						code = 'var btn = document.querySelector("._07bed3a434fa59aa1852a431bf2e19cb-scss"); var checked = btn.getAttribute("aria-checked"); if (checked == "true") { var link = "https://www.myinstants.com/media/sounds/classic_hurt.mp3"; } else { var link = "https://www.myinstants.com/media/sounds/hitmarker_2.mp3"; } var audio = new Audio(link); audio.volume = 0.4; audio.play(); btn.click();';
						break;
					case 'play-pause':
